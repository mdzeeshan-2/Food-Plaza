  ...
  return (
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        Embark on a journey of swift indulgence with our cutting-edge grocery and fruit delivery service in Your City.
         We redefine convenience, seamlessly blending speed and freshness. Our dedicated fleet navigates the city's pulse, 
         ensuring your handpicked items reach your doorstep promptly. Elevate your culinary experience with the assurance of unparalleled delivery speed, 
         a testament to our commitment to seamless, gratifying service.
        </p>
        <motion.button
          {...buttonClcik}
